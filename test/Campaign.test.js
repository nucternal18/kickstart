...
beforeEach(async () => {
  ...
  factory = await new web3.eth.Contract(JSON.parse(compiledFactory.contracts['CampaignFactory'].interface))
    .deploy({
...
describe("Campaigns",() => {
  it("deploys a factory and a campaign", async () => {
    await assert.ok(factory.options.address);
  ...
  it('Allows people to con tribute money and marks them as approvers', async () => {
